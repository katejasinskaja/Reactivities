...
export default class ActivityStore {
    ...
    private setActivity = (activity: Activity) => {
        ...
        if (user) {
            ...
            activity.host = activity.attendees?.find(x => x.username.toLowerCase() === activity.hostUsername?.toLowerCase());
        }
            ...
            runInAction(() => {
                if (this.selectedActivity?.isGoing) {
                    this.selectedActivity.attendees =
                        this.selectedActivity.attendees?.filter(a => a.username.toLowerCase() !== user?.username.toLowerCase());
